...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_two_args(self):
        ut_r1 = Rectangle(10, 2)
        ut_r2 = Rectangle(2, 10)
        self.assertEqual(ut_r1.id, ut_r2.id - 1)

    def test_three_args(self):
        ut_r1 = Rectangle(2, 2, 4)
        ut_r2 = Rectangle(4, 4, 2)
        self.assertEqual(ut_r1.id, ut_r2.id - 1)

    def test_four_args(self):
        ut_r1 = Rectangle(1, 2, 3, 4)
        ut_r2 = Rectangle(4, 3, 2, 1)
        self.assertEqual(ut_r1.id, ut_r2.id - 1)
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def test_str_method_print_width_height(self):
        ...
        crct = "[Rectangle] ({}) 0/0 - 4/6\n".format(r.id)
        self.assertEqual(crct, capture.getvalue())

    def test_str_method_width_height_x(self):
        r = Rectangle(5, 5, 1)
        crct = "[Rectangle] ({}) 1/0 - 5/5".format(r.id)
        self.assertEqual(crct, r.__str__())

    def test_str_method_width_height_x_y(self):
        r = Rectangle(1, 8, 2, 4)
        crct = "[Rectangle] ({}) 2/4 - 1/8".format(r.id)
        self.assertEqual(crct, str(r))
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(None)
        crct = "[Rectangle] ({}) 10/10 - 10/10".format(r.id)
        self.assertEqual(crct, str(r))

    def test_update_args_None_id_and_more(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(None, 4, 5, 2)
        crct = "[Rectangle] ({}) 2/10 - 4/5".format(r.id)
        self.assertEqual(crct, str(r))
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        crct = "[Rectangle] ({}) 10/9 - 10/7".format(r.id)
        self.assertEqual(crct, str(r))
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        ...
        crct = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'width': 10}
        self.assertDictEqual(crct, r.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        ut_r1 = Rectangle(10, 2, 1, 9, 5)
        ut_r2 = Rectangle(5, 9, 1, 2, 10)
        ut_r2.update(**ut_r1.to_dictionary())
        self.assertNotEqual(ut_r1, ut_r2)
