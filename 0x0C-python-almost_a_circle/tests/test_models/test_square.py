#!/usr/bin/python3
# test_square.py
# Mohammed Elgaily <mbajily@gmail.com>
"""Defines unittests"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    ...
    def test_one_arg(self):
        ut_s1 = Square(10)
        ut_s2 = Square(11)
        self.assertEqual(ut_s1.id, ut_s2.id - 1)
...
class TestSquare_area(unittest.TestCase):
    """Unittests for testing the area"""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def test_str_method_print_size(self):
        ...
        crct = "[Square] ({}) 0/0 - 4\n".format(s.id)
        self.assertEqual(crct, capture.getvalue())

    def test_str_method_size_x(self):
        s = Square(5, 5)
        crct = "[Square] ({}) 5/0 - 5".format(s.id)
        self.assertEqual(crct, s.__str__())

    def test_str_method_size_x_y(self):
        s = Square(7, 4, 22)
        crct = "[Square] ({}) 4/22 - 7".format(s.id)
        self.assertEqual(crct, str(s))
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_zero(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update()
        self.assertEqual("[Square] (10) 10/10 - 10", str(ut_s))

    def test_update_args_one(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89)
        self.assertEqual("[Square] (89) 10/10 - 10", str(ut_s))

    def test_update_args_two(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2)
        self.assertEqual("[Square] (89) 10/10 - 2", str(ut_s))

    def test_update_args_three(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2, 3)
        self.assertEqual("[Square] (89) 3/10 - 2", str(ut_s))

    def test_update_args_four(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2, 3, 4)
        self.assertEqual("[Square] (89) 3/4 - 2", str(ut_s))

    def test_update_args_more_than_four(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2, 3, 4, 5)
        self.assertEqual("[Square] (89) 3/4 - 2", str(ut_s))

    def test_update_args_width_setter(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2)
        self.assertEqual(2, ut_s.width)

    def test_update_args_height_setter(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2)
        self.assertEqual(2, ut_s.height)

    def test_update_args_None_id(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(None)
        crct = "[Square] ({}) 10/10 - 10".format(ut_s.id)
        self.assertEqual(crct, str(ut_s))

    def test_update_args_None_id_and_more(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(None, 4, 5)
        crct = "[Square] ({}) 5/10 - 4".format(ut_s.id)
        self.assertEqual(crct, str(ut_s))

    def test_update_args_twice(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2, 3, 4)
        ut_s.update(4, 3, 2, 89)
        self.assertEqual("[Square] (4) 2/89 - 3", str(ut_s))

    def test_update_args_invalid_size_type(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            ut_s.update(89, "invalid")
    ...
    def test_update_args_invalid_y(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            ut_s.update(89, 1, 2, "invalid")

    def test_update_args_y_negative(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
            ut_s.update(98, 1, 2, -4)

    def test_update_args_size_before_x(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            ut_s.update(89, "invalid", "invalid")

    def test_update_args_size_before_y(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            ut_s.update(89, "invalid", 2, "invalid")

    def test_update_args_x_before_y(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            ut_s.update(89, 1, "invalid", "invalid")
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_one(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(id=1)
        self.assertEqual("[Square] (1) 10/10 - 10", str(ut_s))

    def test_update_kwargs_two(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(size=1, id=2)
        self.assertEqual("[Square] (2) 10/10 - 1", str(ut_s))

    def test_update_kwargs_three(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(y=1, size=3, id=89)
        self.assertEqual("[Square] (89) 10/1 - 3", str(ut_s))

    def test_update_kwargs_four(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(id=89, x=1, y=3, size=4)
        self.assertEqual("[Square] (89) 1/3 - 4", str(ut_s))

    def test_update_kwargs_width_setter(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(id=89, size=8)
        self.assertEqual(8, ut_s.width)

    def test_update_kwargs_height_setter(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(id=89, size=9)
        self.assertEqual(9, ut_s.height)
    ...
    def test_update_kwargs_None_id_and_more(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(id=None, size=7, x=18)
        crct = "[Square] ({}) 18/10 - 7".format(ut_s.id)
        self.assertEqual(crct, str(ut_s))

    def test_update_kwargs_twice(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(id=89, x=1)
        ut_s.update(y=3, x=15, size=2)
        self.assertEqual("[Square] (89) 15/3 - 2", str(ut_s))

    def test_update_kwargs_invalid_size(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            ut_s.update(size="invalid")
    ...
    def test_update_args_and_kwargs(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(89, 2, y=6)
        self.assertEqual("[Square] (89) 10/10 - 2", str(ut_s))

    def test_update_kwargs_wrong_keys(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(a=5, b=10)
        self.assertEqual("[Square] (10) 10/10 - 10", str(ut_s))

    def test_update_kwargs_some_wrong_keys(self):
        ut_s = Square(10, 10, 10, 10)
        ut_s.update(size=5, id=89, a=1, b=54)
        self.assertEqual("[Square] (89) 10/10 - 5", str(ut_s))


class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests for testing to_dictionary method of the Square clasut_s."""

    def test_to_dictionary_output(self):
        ut_s = Square(10, 2, 1, 1)
        crct = {'id': 1, 'x': 2, 'size': 10, 'y': 1}
        self.assertDictEqual(crct, ut_s.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        ut_s1 = Square(10, 2, 1, 2)
        ut_s2 = Square(1, 2, 10)
        ut_s2.update(**ut_s1.to_dictionary())
        self.assertNotEqual(ut_s1, ut_s2)

    def test_to_dictionary_arg(self):
        ut_s = Square(10, 10, 10, 10)
        with self.assertRaises(TypeError):
            ut_s.to_dictionary(1)
